...
import 'package:serialtv/domain/usecases/get_serial_tv_detail.dart';
import 'package:serialtv/domain/usecases/get_watchlist_status_serial_tv.dart';
...
class GetDetailSerialBloc
  ...
  GetDetailSerialBloc(this._getSerialDetail, this._getWatchListStatus)
  ...
  Future<void> _onRequested(
    GetDetailSerialRequested event,
    Emitter<GetDetailSerialState> emit,
  ) async {
    ...
    await result.fold(
      ...
      (serial) async {
        ...
        emit(GetDetailSerialLoaded(serial, isAddedToWatchlist: status));
      },
    );
  }

  Future<void> _onStatusRequested(
    GetStatusWatchlistSerialRequested event,
    Emitter<GetDetailSerialState> emit,
  ) async {
